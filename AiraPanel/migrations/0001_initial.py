    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='AiraPanel.Categories')),
                ('manufaturer', models.ManyToManyField(to='AiraPanel.Companies')),
                ('subcategory', models.ManyToManyField(to='AiraPanel.SubCategories')),
                ('unit', models.ManyToManyField(to='AiraPanel.Units')),
            ],
        ),
    ]
